export const pizza = {
    ...
    setup: [
        { id: 101, name: 'Completa', description: 'Pizza completa sin división',
            factor: 1 },
        { id: 102, name: 'Mitades', description: 'Dividir en dos mitades iguales',
            factor: 1.5},
    ],
    sauce: [
            {
    ...
    extras: [
            {
                id: 50, name: 'sin extras',
                description: 'Pizza sin añadidos extra',
                precio: 0
            },
            {
                id: 51, name: 'aceitunas verdes',
                description: 'Clásicas, saladas y suaves',
                precio: 1000
            },
            {
                id: 52, name: 'aceitunas negras',
            ...
            {
                id: 63, name: 'champignones',
                description: 'Hongos blancos de sabor terroso',
                precio: 6000
            },
            {
                id: 64, name: 'alcaparras',
